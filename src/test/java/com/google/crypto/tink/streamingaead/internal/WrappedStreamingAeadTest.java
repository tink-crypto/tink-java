...
public class WrappedStreamingAeadTest {
  ...
  public void encryptDecrypt_usesPrimary() throws Exception {
    ...
    StreamingAead fullStreamingAead =
        WrappedStreamingAead.wrap(fullKeysetHandle, WrappedStreamingAeadTest::primitiveFactory);
    StreamingAead onlyPrimaryStreamingAead =
        WrappedStreamingAead.wrap(
            onlyPrimaryKeysetHandle, WrappedStreamingAeadTest::primitiveFactory);
  ...
  public void encryptDecrypt_shiftedPrimaryWorks() throws Exception {
    ...
    StreamingAead shiftedPrimaryStreamingAead =
        WrappedStreamingAead.wrap(
            shiftedPrimaryKeysetHandle, WrappedStreamingAeadTest::primitiveFactory);
  ...
  public void wrongKey_throws() throws Exception {
    ...
    StreamingAead aesCtrHmac =
        WrappedStreamingAead.wrap(
            aesCtrHmacKeysetHandle, WrappedStreamingAeadTest::primitiveFactory);
    StreamingAead aesGcmHkdf =
        WrappedStreamingAead.wrap(
            aesGcmHkdfKeysetHandle, WrappedStreamingAeadTest::primitiveFactory);
    ...
    StreamingAead streamingAeadWithKeyDisabled =
        WrappedStreamingAead.wrap(
            KeysetHandle.newBuilder()
                ...
                .addEntry(
                    KeysetHandle.importKey(aesGcmHkdfStreamingKey).withFixedId(42).makePrimary())
                .build(),
            WrappedStreamingAeadTest::primitiveFactory);
    StreamingAead streamingAeadWithKeyPrimary =
        WrappedStreamingAead.wrap(
            KeysetHandle.newBuilder()
                .addEntry(
                    KeysetHandle.importKey(aesCtrHmacStreamingKey).withFixedId(43).makePrimary())
                .build(),
            WrappedStreamingAeadTest::primitiveFactory);
  ...
  private static StreamingAead primitiveFactory(KeysetHandleInterface.Entry entry)
    ...
    throw new GeneralSecurityException("Could not create primitive for key " + key.getClass());
  }
}
