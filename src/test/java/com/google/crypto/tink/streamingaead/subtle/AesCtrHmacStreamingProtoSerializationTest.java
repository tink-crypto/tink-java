...
/** Test for {@link AesCtrHmacStreamingProtoSerialization}. */
...
public final class AesCtrHmacStreamingProtoSerializationTest {
  ...
  public void serializeParseParameters_simple() throws Exception {
    ...
    ProtoParametersSerialization serialized =
        AesCtrHmacStreamingProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesCtrHmacStreamingKeyFormat.parser(),
        serialized,
        serialization);

    Parameters parsed = AesCtrHmacStreamingProtoSerialization.parseParameters(serialization);
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        ...
        () -> AesCtrHmacStreamingProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void serializeParseKey_simple() throws Exception {
    ...
    ProtoKeySerialization serialized =
        AesCtrHmacStreamingProtoSerialization.serializeKey(key, InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
