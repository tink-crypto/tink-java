...
/** Test for {@link AesGcmHkdfStreamingProtoSerialization}. */
...
public final class AesGcmHkdfStreamingProtoSerializationTest {
  ...
  public void serializeParseParameters_simple() throws Exception {
    ...
    ProtoParametersSerialization serialized =
        AesGcmHkdfStreamingProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesGcmHkdfStreamingKeyFormat.parser(),
        serialized,
        serialization);

    Parameters parsed = AesGcmHkdfStreamingProtoSerialization.parseParameters(serialization);
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        ...
        () -> AesGcmHkdfStreamingProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void serializeParseKey_simple() throws Exception {
    ...
    ProtoKeySerialization serialized =
        AesGcmHkdfStreamingProtoSerialization.serializeKey(key, InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
