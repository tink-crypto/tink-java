...
public class StreamingAeadConfigurationV1Test {
  @Test
  public void config_throwsIfInFipsMode() throws Exception {
    Assume.assumeTrue(TinkFipsUtil.useOnlyFips());

    assertThrows(GeneralSecurityException.class, StreamingAeadConfigurationV1::get);
  }
  ...
  public void config_containsAesGcmHkdfStreamingAead() throws Exception {
    ...
    assertThat(keysetHandle.getPrimitive(StreamingAeadConfigurationV1.get(), StreamingAead.class))
        .isNotNull();
  }
