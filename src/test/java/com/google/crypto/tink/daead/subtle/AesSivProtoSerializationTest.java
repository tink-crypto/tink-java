...
public final class AesSivProtoSerializationTest {
  ...
  public void serializeParseParameters_noPrefix() throws Exception {
    ...
    ProtoParametersSerialization serialized =
        AesSivProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesSivKeyFormat.parser(), serialized, serialization);

    Parameters parsed = AesSivProtoSerialization.parseParameters(serialization);
  ...
  public void serializeParseKey_noPrefix() throws Exception {
    ...
    ProtoKeySerialization serialized =
        AesSivProtoSerialization.serializeKey(key, InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesSivKey.parser(), serialized, serialization);

    Key parsed = AesSivProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get());
  ...
  public void testParseKeys_noAccess_throws() throws Exception {
    ...
    assertThrows(
        ...
        () -> AesSivProtoSerialization.parseKey(serialization, null));
  }
  ...
  public void testSerializeKeys_noAccess_throws() throws Exception {
    ...
    AesSivKey key =
        AesSivKey.builder()
            ...
            .build();
    assertThrows(
        GeneralSecurityException.class, () -> AesSivProtoSerialization.serializeKey(key, null));
  }
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesSivProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void testParseInvalidKeys_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesSivProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get()));
  }
}
