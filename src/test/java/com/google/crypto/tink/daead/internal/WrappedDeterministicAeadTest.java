...
public class WrappedDeterministicAeadTest {
  ...
  private static DeterministicAead primitiveFactory(KeysetHandleInterface.Entry entry)
      throws GeneralSecurityException {
    return AesSiv.create((AesSivKey) entry.getKey());
  }
  ...
  public void encrytDecrypt_withoutAnnotations_noLogs() throws Exception {
    ...
    DeterministicAead daead =
        WrappedDeterministicAead.create(
            keysetHandle, WrappedDeterministicAeadTest::primitiveFactory);
  ...
  public void encryptDecrypt_keysetWithMultipleKeys_works() throws Exception {
    ...
    DeterministicAead daead =
        WrappedDeterministicAead.create(
            mainKeysetHandle, WrappedDeterministicAeadTest::primitiveFactory);
  ...
  public void encryptDecrypt_differentKeysets_works() throws Exception {
    ...
    DeterministicAead daeadRaw =
        WrappedDeterministicAead.create(
            rawKeyKeysetHandle, WrappedDeterministicAeadTest::primitiveFactory);
  ...
  public void encryptDecrypt_differentKeys_fails() throws Exception {
    ...
    DeterministicAead daead2 =
        WrappedDeterministicAead.create(
            otherKeyKeysetHandle, WrappedDeterministicAeadTest::primitiveFactory);
    ...
    DeterministicAead deadWithKeyPrimary =
        WrappedDeterministicAead.create(
            KeysetHandle.newBuilder()
                .addEntry(KeysetHandle.importKey(rawKey).withFixedId(43).makePrimary())
                .build(),
            WrappedDeterministicAeadTest::primitiveFactory);
  ...
  public void encryptDecrypt_withAnnotations_hasMonitoring() throws Exception {
    ...
    DeterministicAead daead2 =
        WrappedDeterministicAead.create(
            keysetHandle2, WrappedDeterministicAeadTest::primitiveFactory);
  ...
  private static DeterministicAead failingPrimitiveFactory(KeysetHandleInterface.Entry entry)
      throws GeneralSecurityException {
    return new AlwaysFailingDeterministicAead(((AesSivKey) entry.getKey()));
  }
  ...
  public void encryptDecryptFailingDAead_withAnnotations_hasMonitoring() throws Exception {
    ...
    DeterministicAead daead =
        WrappedDeterministicAead.create(
            keysetHandle, WrappedDeterministicAeadTest::failingPrimitiveFactory);
