...
/**
 * Tests for {@link KeyDerivationConfig2026} which run under FIPS mode.
 *
 ...
 * </ul>
 *
 * <p>Since {@link KeyDerivationConfig2026} contains no FIPS-compliant algorithms, in FIPS mode
 * {@code KeyDerivationConfig2026.get()} returns an empty configuration rather than throwing an
...
public final class KeyDerivationConfig2026FipsTest {
  ...
  public void get_returnsEmptyConfigurationInFipsMode() throws Exception {
    ...
    assertThrows(
        ...
        () -> KeysetHandle.generateNew(parameters, KeyDerivationConfig2026.get()));
  }
}
