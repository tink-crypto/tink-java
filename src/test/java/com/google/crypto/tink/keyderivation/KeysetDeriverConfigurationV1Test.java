...
public class KeysetDeriverConfigurationV1Test {
  ...
  public void config_throwsIfInFipsMode() throws Exception {
    ...
    assertThrows(GeneralSecurityException.class, KeysetDeriverConfigurationV1::get);
  }
  ...
  public void config_containsPrfBasedKeyDerivation() throws Exception {
    ...
    assertThat(handle.getPrimitive(KeysetDeriverConfigurationV1.get(), KeysetDeriver.class))
        .isNotNull();
    assertThrows(
  ...
  public void config_handlesLegacyKey() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> handle.getPrimitive(KeysetDeriverConfigurationV1.get(), KeysetDeriver.class));
  }
}
