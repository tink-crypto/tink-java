...
/** Test for {@link HkdfPrfProtoSerialization}. */
...
public final class HkdfPrfProtoSerializationTest {
  ...
  public void serializeAndParseParameters(
    ...
    ProtoParametersSerialization serialized =
        HkdfPrfProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.HkdfPrfKeyFormat.parser(), serialized, serialization);

    Parameters parsed = HkdfPrfProtoSerialization.parseParameters(serialization);
  ...
  public void serializeAndParseKey(
    ...
    ProtoKeySerialization serialized =
        HkdfPrfProtoSerialization.serializeKey(key, InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.HkdfPrfKey.parser(), serialized, serialization);

    Key parsed = HkdfPrfProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get());
  ...
  public void testSerializeKey_noAccess_fails() throws Exception {
    HkdfPrfKey key =
        HkdfPrfKey.builder()
            ...
            .build();
    assertThrows(
        GeneralSecurityException.class, () -> HkdfPrfProtoSerialization.serializeKey(key, null));
  }
  ...
  public void testParseKey_noAccess_fails() throws Exception {
    ...
    assertThrows(
        ...
        () -> HkdfPrfProtoSerialization.parseKey(serialization, null));
  }
  ...
  public void testParseParameters_withInvalidTypeUrl_fails() throws Exception {
    ...
    assertThrows(
        ...
        () -> HkdfPrfProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void testParseKey_withInvalidTypeUrl_fails() throws Exception {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> HkdfPrfProtoSerialization.parseKey(serialization, access));
  }
