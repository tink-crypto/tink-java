...
/** Tests for WrappedPrfSet. */
@RunWith(JUnit4.class)
public class WrappedPrfSetTest {
  ...
  private static Prf createPrf(KeysetHandleInterface.Entry entry) throws GeneralSecurityException {
    return PrfImpl.wrap(HkdfStreamingPrf.create((HkdfPrfKey) entry.getKey()));
  }
  ...
  public void prfsCorrespondToCorrectKeys() throws Exception {
    ...
    PrfSet singleKeyPrfSet =
        WrappedPrfSet.create(singleKeyKeysetHandle, WrappedPrfSetTest::createPrf);
    byte[] plaintext = "blah".getBytes(UTF_8);
  ...
  public void testWithAnnotations_hasMonitoring() throws Exception {
    ...
    PrfSet prfSet = WrappedPrfSet.create(hkdfKeysetHandle, WrappedPrfSetTest::createPrf);
  ...
  public void testAlwaysFailingPrfWithAnnotations_hasMonitoring() throws Exception {
    ...
    KeysetHandle hkdfKeysetHandle =
        KeysetHandle.newBuilder()
            ...
            .build();
    PrfSet prfSet =
        WrappedPrfSet.create(
            hkdfKeysetHandle,
            (entry) -> {
              return new AlwaysFailingPrf((HkdfPrfKey) entry.getKey());
            });
    byte[] plaintext = "blah".getBytes(UTF_8);
