...
/** Unit tests for {@link AesCmacPrf}. */
@RunWith(Theories.class)
@LowLevelCryptoCaller
public class AesCmacPrfTest {

  private static final int KEY_SIZE = 16;

  private static Prf createAesCmacPrf(byte[] rawKeyBytes) throws GeneralSecurityException {
    AesCmacPrfParameters parameters = AesCmacPrfParameters.create(rawKeyBytes.length);
  ...
  public void compute_isCorrect(
    ...
    Prf prf =
        createAesCmacPrf(
            testVector.key().getKeyBytes().toByteArray(InsecureSecretKeyAccess.get()));
  ...
  public void createWithAesCmacPrfKey_compute_isCorrect(
      @FromDataPoints("AesCmacPrfTestVectors") AesCmacPrfTestUtil.TestVector testVector)
      throws Exception {
    Prf prf = AesCmacPrf.create(testVector.key());
  ...
  public void compute_outputLengthTooLarge_throws() throws Exception {
    Prf prf = createAesCmacPrf(Hex.decode("2b7e151628aed2a6abf7158809cf4f3c"));
