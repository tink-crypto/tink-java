...
/** Test for {@link AesCmacPrfProtoSerialization}. */
...
public final class AesCmacPrfProtoSerializationTest {
  ...
  public void serializeAndParseParameters(@FromDataPoints("keySizes") int keySize)
    ...
    ProtoParametersSerialization serialized =
        AesCmacPrfProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesCmacPrfKeyFormat.parser(), serialized, serialization);

    Parameters parsed = AesCmacPrfProtoSerialization.parseParameters(serialization);
  ...
  public void serializeAndParseKey(@FromDataPoints("keySizes") int keySize) throws Exception {
    ...
    ProtoKeySerialization serialized =
        AesCmacPrfProtoSerialization.serializeKey(key, InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesCmacPrfKey.parser(), serialized, serialization);

    Key parsed = AesCmacPrfProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get());
  ...
  public void testSerializeKey_noAccess_fails() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class, () -> AesCmacPrfProtoSerialization.serializeKey(key, null));
  }
  ...
  public void testParseKey_noAccess_fails() throws Exception {
    ...
    assertThrows(
        ...
        () -> AesCmacPrfProtoSerialization.parseKey(serialization, null));
  }
  ...
  public void testParseParameters_withInvalidTypeUrl_fails() throws Exception {
    ...
    assertThrows(
        ...
        () -> AesCmacPrfProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void testParseKey_withInvalidTypeUrl_fails() throws Exception {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> AesCmacPrfProtoSerialization.parseKey(serialization, access));
  }
