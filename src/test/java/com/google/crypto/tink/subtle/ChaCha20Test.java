...
public class ChaCha20Test {
  ...
  public void testWithRfc7539TestVectors() throws Exception {
    for (Rfc7539TestVector test : rfc7539TestVectors) {
      IndCpaCipher cipher = new ChaCha20(test.key, test.initialCounter);
      byte[] out = cipher.decrypt(Bytes.concat(test.nonce, test.ciphertext));
