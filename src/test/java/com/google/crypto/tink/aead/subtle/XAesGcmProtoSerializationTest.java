...
/** Test for {@link XAesGcmProtoSerialization}. */
...
public final class XAesGcmProtoSerializationTest {
  ...
  public void serializeParseParameters_noPrefix() throws Exception {
    ...
    ProtoParametersSerialization serialized =
        XAesGcmProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.XAesGcmKeyFormat.parser(), serialized, serialization);

    Parameters parsed = XAesGcmProtoSerialization.parseParameters(serialization);
  ...
  public void serializeParseKey_noPrefix() throws Exception {
    ...
    ProtoKeySerialization serialized =
        XAesGcmProtoSerialization.serializeKey(key, InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.XAesGcmKey.parser(), serialized, serialization);

    Key parsed = XAesGcmProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get());
  ...
  public void testParseKeys_noAccess_throws() throws Exception {
    ...
    assertThrows(
        ...
        () -> XAesGcmProtoSerialization.parseKey(serialization, null));
  }
  ...
  public void parseKey_legacy_fails() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> XAesGcmProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get()));
  }
  ...
  public void testSerializeKeys_noAccess_throws() throws Exception {
    XAesGcmKey key =
        XAesGcmKey.create(
            ...
            /* idRequirement= */ 123);
    assertThrows(
        GeneralSecurityException.class, () -> XAesGcmProtoSerialization.serializeKey(key, null));
  }
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> XAesGcmProtoSerialization.parseParameters(serializedParameters));
  }
