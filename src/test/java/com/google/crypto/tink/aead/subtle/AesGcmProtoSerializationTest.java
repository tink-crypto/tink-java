...
/** Test for {@link AesGcmProtoSerialization}. */
...
public final class AesGcmProtoSerializationTest {
  ...
  public void serializeParseParameters_noPrefix() throws Exception {
    ...
    ProtoParametersSerialization serialized =
        AesGcmProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesGcmKeyFormat.parser(), serialized, serialization);

    Parameters parsed = AesGcmProtoSerialization.parseParameters(serialization);
  ...
  public void serializeParseKey_noPrefix() throws Exception {
    ...
    ProtoKeySerialization serialized =
        AesGcmProtoSerialization.serializeKey(key, InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesGcmKey.parser(), serialized, serialization);

    Key parsed = AesGcmProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get());
  ...
  public void testParseKeys_noAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesGcmProtoSerialization.parseKey(serialization, null));
  }
  ...
  public void testSerializeKeys_noAccess_throws() throws Exception {
    ...
    AesGcmKey key =
        AesGcmKey.builder()
            ...
            .build();
    assertThrows(
        GeneralSecurityException.class, () -> AesGcmProtoSerialization.serializeKey(key, null));
  }
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesGcmProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void testParseInvalidKeys_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesGcmProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get()));
  }
}
