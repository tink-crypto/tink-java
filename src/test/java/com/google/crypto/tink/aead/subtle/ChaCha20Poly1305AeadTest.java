...
/** Unit tests for {@link ChaCha20Poly1305Aead}. */
@RunWith(JUnit4.class)
@LowLevelCryptoCaller
public final class ChaCha20Poly1305AeadTest {
  ...
  public Aead createInstance(final byte[] keyBytes) throws GeneralSecurityException {
    ...
    return ChaCha20Poly1305Aead.create(key);
  }

  @Test
  public void create_nullKey_throws() throws Exception {
    assertThrows(NullPointerException.class, () -> ChaCha20Poly1305Aead.create(null));
  }

  @Test
  public void testSnufflePoly1305ThrowsIllegalArgExpWhenKeyLenIsGreaterThan32() throws Exception {
    Assume.assumeFalse(TinkFips.useOnlyFips());

    GeneralSecurityException e =
        assertThrows(GeneralSecurityException.class, () -> createInstance(new byte[KEY_SIZE + 1]));
    assertThat(e).hasMessageThat().containsMatch("key of length 32 bytes");
  }

  @Test
  public void testSnufflePoly1305ThrowsIllegalArgExpWhenKeyLenIsLessThan32() throws Exception {
    Assume.assumeFalse(TinkFips.useOnlyFips());
  ...
  public void testFailIfFipsModuleNotAvailable() throws Exception {
    ...
    byte[] keyBytes = Random.randBytes(32);
    ChaCha20Poly1305Key key =
        ChaCha20Poly1305Key.create(SecretBytes.copyFrom(keyBytes, InsecureSecretKeyAccess.get()));
    assertThrows(GeneralSecurityException.class, () -> ChaCha20Poly1305Aead.create(key));
  }
  ...
  public void testWithChaCha20Poly1305Key_noPrefix_works() throws Exception {
    ...
    ChaCha20Poly1305Key key =
        ChaCha20Poly1305Key.create(SecretBytes.copyFrom(keyBytes, InsecureSecretKeyAccess.get()));
    Aead aead = ChaCha20Poly1305Aead.create(key);
