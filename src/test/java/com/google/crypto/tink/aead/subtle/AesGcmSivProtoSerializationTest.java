...
/** Test for {@link AesGcmSivProtoSerialization}. */
...
public final class AesGcmSivProtoSerializationTest {
  ...
  public void serializeParseParameters_noPrefix() throws Exception {
    ...
    ProtoParametersSerialization serialized =
        AesGcmSivProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesGcmSivKeyFormat.parser(), serialized, serialization);

    Parameters parsed = AesGcmSivProtoSerialization.parseParameters(serialization);
  ...
  public void serializeParseKey_noPrefix() throws Exception {
    ...
    ProtoKeySerialization serialized =
        AesGcmSivProtoSerialization.serializeKey(key, InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesGcmSivKey.parser(), serialized, serialization);

    Key parsed = AesGcmSivProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get());
  ...
  public void testParseKeys_noAccess_throws() throws Exception {
    ...
    assertThrows(
        ...
        () -> AesGcmSivProtoSerialization.parseKey(serialization, null));
  }
  ...
  public void testSerializeKeys_noAccess_throws() throws Exception {
    ...
    AesGcmSivKey key =
        AesGcmSivKey.builder()
            ...
            .build();
    assertThrows(
        GeneralSecurityException.class, () -> AesGcmSivProtoSerialization.serializeKey(key, null));
  }
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesGcmSivProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void testParseInvalidKeys_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesGcmSivProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get()));
  }
}
