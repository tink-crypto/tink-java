...
/** Test for {@link AesCtrHmacAeadProtoSerialization}. */
...
public final class AesCtrHmacAeadProtoSerializationTest {
  ...
  public void serializeParseParameters_noPrefix_sha1_equal() throws Exception {
    ...
    ProtoParametersSerialization serialized =
        AesCtrHmacAeadProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesCtrHmacAeadKeyFormat.parser(), serialized, serialization);

    Parameters parsed = AesCtrHmacAeadProtoSerialization.parseParameters(serialization);
  ...
  public void serializeParseKey_noPrefix_sha1_equal() throws Exception {
    ...
    ProtoKeySerialization serialized =
        AesCtrHmacAeadProtoSerialization.serializeKey(key, InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesCtrHmacAeadKey.parser(), serialized, serialization);

    Key parsed =
        AesCtrHmacAeadProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get());
  ...
  public void testParseKeys_noAccess_throws() throws Exception {
    ...
    assertThrows(
        ...
        () -> AesCtrHmacAeadProtoSerialization.parseKey(serialization, null));
  }
  ...
  public void testSerializeKeys_noAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesCtrHmacAeadProtoSerialization.serializeKey(key, null));
  }
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesCtrHmacAeadProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void testParseInvalidKeys_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () ->
            AesCtrHmacAeadProtoSerialization.parseKey(
