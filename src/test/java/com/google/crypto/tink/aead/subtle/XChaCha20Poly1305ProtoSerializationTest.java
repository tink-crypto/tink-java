...
/** Test for {@link XChaCha20Poly1305ProtoSerialization}. */
...
public final class XChaCha20Poly1305ProtoSerializationTest {
  ...
  public void serializeParseParameters_noPrefix() throws Exception {
    ...
    ProtoParametersSerialization serialized =
        XChaCha20Poly1305ProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.XChaCha20Poly1305KeyFormat.parser(),
        serialized,
        serialization);

    Parameters parsed = XChaCha20Poly1305ProtoSerialization.parseParameters(serialization);
  ...
  public void serializeParseKey_tink() throws Exception {
    ...
    ProtoKeySerialization serialized =
        XChaCha20Poly1305ProtoSerialization.serializeKey(key, InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.XChaCha20Poly1305Key.parser(), serialized, serialization);

    Key parsed =
        XChaCha20Poly1305ProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get());
  ...
  public void testParseKeys_noAccess_throws() throws Exception {
    ...
    assertThrows(
        ...
        () -> XChaCha20Poly1305ProtoSerialization.parseKey(serialization, null));
  }
  ...
  public void testSerializeKeys_noAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> XChaCha20Poly1305ProtoSerialization.serializeKey(key, null));
  }
  ...
  public static final ProtoParametersSerialization[] invalidParametersSerializations =
      createInvalidParametersSerializations();
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> XChaCha20Poly1305ProtoSerialization.parseParameters(serializedParameters));
  }
