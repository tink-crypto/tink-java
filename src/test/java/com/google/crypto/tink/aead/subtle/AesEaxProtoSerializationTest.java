...
/** Test for {@link AesEaxProtoSerialization}. */
...
public final class AesEaxProtoSerializationTest {
  ...
  public void serializeParseParameters_noPrefix() throws Exception {
    ...
    ProtoParametersSerialization serialized =
        AesEaxProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesEaxKeyFormat.parser(), serialized, serialization);

    Parameters parsed = AesEaxProtoSerialization.parseParameters(serialization);
  ...
  public void serializeParseKey_noPrefix() throws Exception {
    ...
    ProtoKeySerialization serialized =
        AesEaxProtoSerialization.serializeKey(key, InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.AesEaxKey.parser(), serialized, serialization);

    Key parsed = AesEaxProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get());
  ...
  public void testParseKeys_noAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesEaxProtoSerialization.parseKey(serialization, null));
  }
  ...
  public void testSerializeKeys_noAccess_throws() throws Exception {
    ...
    AesEaxKey key =
        AesEaxKey.builder()
            ...
            .build();
    assertThrows(
        GeneralSecurityException.class, () -> AesEaxProtoSerialization.serializeKey(key, null));
  }
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesEaxProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void testParseInvalidKeys_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesEaxProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get()));
  }
}
