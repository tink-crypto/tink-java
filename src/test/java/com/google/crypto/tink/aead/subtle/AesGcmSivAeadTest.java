...
/** Unit tests for {@link AesGcmSivAead}. */
@RunWith(JUnit4.class)
@LowLevelCryptoCaller
public final class AesGcmSivAeadTest {

  private static final Integer[] keySizeInBytes = new Integer[] {16, 32};

  private static Aead getAead(byte[] keyBytes) throws GeneralSecurityException {
    ...
    AesGcmSivKey key =
        AesGcmSivKey.builder()
            ...
            .build();
    return AesGcmSivAead.create(key);
  }
  ...
  public void testNullPlaintextOrCiphertext() throws Exception {
    ...
    for (int keySize : keySizeInBytes) {
      Aead gcm = getAead(Random.randBytes(keySize));
      byte[] aad = new byte[] {1, 2, 3};
      assertThrows(
  ...
  public void testCreate_encryptAndDecryptFailBeforeAndroid30() throws Exception {
    ...
    AesGcmSivKey key =
        AesGcmSivKey.builder()
            ...
            .setKeyBytes(SecretBytes.copyFrom(keyBytes, InsecureSecretKeyAccess.get()))
            .build();
    assertThrows(GeneralSecurityException.class, () -> AesGcmSivAead.create(key));
  }
  ...
  public void testWithAesGcmSivKey_noPrefix_works() throws Exception {
    ...
    AesGcmSivKey key =
        AesGcmSivKey.builder()
            ...
            .setKeyBytes(SecretBytes.copyFrom(keyBytes, InsecureSecretKeyAccess.get()))
            .build();
    Aead aead = AesGcmSivAead.create(key);
