...
/** Unit tests for {@link XChaCha20Poly1305Aead}. */
@RunWith(JUnit4.class)
@LowLevelCryptoCaller
public final class XChaCha20Poly1305AeadTest {
  ...
  public void testXChaCha20Poly1305TestVectors() throws Exception {
    for (XChaCha20Poly1305TestVector test : xChaCha20Poly1305TestVectors) {
      Aead cipher = createInstance(test.key);
      byte[] message =
  ...
  public Aead createInstance(byte[] keyBytes) throws GeneralSecurityException {
    XChaCha20Poly1305Key key =
        XChaCha20Poly1305Key.create(SecretBytes.copyFrom(keyBytes, InsecureSecretKeyAccess.get()));
    return XChaCha20Poly1305Aead.create(key);
  }

  @Test
  public void create_nullKey_throws() throws Exception {
    assertThrows(NullPointerException.class, () -> XChaCha20Poly1305Aead.create(null));
  }
  ...
  public void testWithXChaCha20Poly1305Key_noPrefix_works() throws Exception {
    ...
    XChaCha20Poly1305Key key =
        XChaCha20Poly1305Key.create(SecretBytes.copyFrom(keyBytes, InsecureSecretKeyAccess.get()));
    Aead aead = XChaCha20Poly1305Aead.create(key);
