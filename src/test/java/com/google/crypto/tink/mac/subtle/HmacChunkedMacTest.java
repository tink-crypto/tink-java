...
public class HmacChunkedMacTest {
  ...
  public void testComputationVerification_includeKeyPrefixWhenPresent(
    ...
    ChunkedMac chunkedMac = HmacChunkedMac.create(t.key);
    ...
    try {
      ChunkedMacVerification chunkedMacVerification = chunkedMac.createVerification(t.tag);
      chunkedMacVerification.update(ByteBuffer.wrap(t.message));
  ...
  public void testCreateVerificationFailsFast(
    ...
    assumeTrue(!TinkFips.useOnlyFips() || TinkFipsUtil.fipsModuleAvailable());
    ChunkedMac mac = HmacChunkedMac.create(t.key);
  ...
  public void testFailsIfFipsModuleNotAvailable() {
    ...
    assertThrows(
        ...
        () -> HmacChunkedMac.create(HmacTestUtil.HMAC_TEST_VECTORS[0].key));
  }
