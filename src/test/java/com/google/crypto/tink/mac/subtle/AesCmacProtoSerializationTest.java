...
/** Test for {@link AesCmacProtoSerialization}. */
...
public final class AesCmacProtoSerializationTest {
  ...
  public void testSerializeParameters(
    ...
    ProtoParametersSerialization serializedParameters =
        AesCmacProtoSerialization.serializeParameters((AesCmacParameters) pair.getParameters());
  ...
  public void testParseValidParameters(
      @FromDataPoints("validParameters") ParametersWithSerialization pair) throws Exception {
    Parameters parsed = AesCmacProtoSerialization.parseParameters(pair.getSerializedParameters());
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        ...
        () -> AesCmacProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void testSerializeKeys(@FromDataPoints("validKeys") KeyWithSerialization pair)
    ...
    ProtoKeySerialization tinkFormatSerialized =
        AesCmacProtoSerialization.serializeKey(
            (AesCmacKey) pair.getKey(), InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
  ...
  public void testParseKeys(@FromDataPoints("validKeys") KeyWithSerialization pair)
      throws Exception {
    Key parsed =
        AesCmacProtoSerialization.parseKey(pair.getSerialization(), InsecureSecretKeyAccess.get());
  ...
  public void testSerializeKeys_noAccess_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesCmacProtoSerialization.serializeKey((AesCmacKey) pair.getKey(), null));
  }
  ...
  public void testParseKeys_noAccess_throws(@FromDataPoints("validKeys") KeyWithSerialization pair)
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesCmacProtoSerialization.parseKey(pair.getSerialization(), null));
  }
  ...
  public void testParseInvalidKeys_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> AesCmacProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get()));
  }
  ...
  public void parseParameters_wrongTypeUrl_throws() throws Exception {
    ...
    assertThrows(
        ...
        () -> AesCmacProtoSerialization.parseParameters(serialization));
  }
  ...
  public void parseKey_wrongTypeUrl_throws() throws Exception {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> AesCmacProtoSerialization.parseKey(serialization, access));
  }
}
