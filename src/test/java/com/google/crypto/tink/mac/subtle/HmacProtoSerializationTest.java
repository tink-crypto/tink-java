...
/** Test for {@link HmacProtoSerialization}. */
...
public final class HmacProtoSerializationTest {
  ...
  public void serializeParseParameters_noPrefix_sha1_equal() throws Exception {
    ...
    ProtoParametersSerialization serialized =
        HmacProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.HmacKeyFormat.parser(),
        serialized,
        serialization);

    Parameters parsed = HmacProtoSerialization.parseParameters(serialization);
  ...
  public void serializeParseKey_noPrefix_sha1_equal() throws Exception {
    ...
    ProtoKeySerialization serialized =
        HmacProtoSerialization.serializeKey(key, InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.HmacKey.parser(), serialized, serialization);

    Key parsed = HmacProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get());
  ...
  public void testParseKeys_noAccess_throws()
    ...
    ProtoKeySerialization serialization =
        ProtoKeySerialization.create(
            ...
            /*idRequirement=*/ 123);
    assertThrows(
        GeneralSecurityException.class, () -> HmacProtoSerialization.parseKey(serialization, null));
  }
  ...
  public void testSerializeKeys_noAccess_throws() throws Exception {
    ...
    HmacKey key = HmacKey.builder()
        ...
        .build();
    assertThrows(
        GeneralSecurityException.class, () -> HmacProtoSerialization.serializeKey(key, null));
  }
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        ...
        () -> HmacProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void testParseInvalidKeys_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> HmacProtoSerialization.parseKey(serialization, InsecureSecretKeyAccess.get()));
  }
}
