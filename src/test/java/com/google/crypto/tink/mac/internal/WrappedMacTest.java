...
public class WrappedMacTest {
  ...
  private static Mac primitiveFactory(KeysetHandleInterface.Entry entry)
      throws GeneralSecurityException {
    if (entry.getKey() instanceof HmacKey) {
      return PrfMac.create((HmacKey) entry.getKey());
    }
    if (entry.getKey() instanceof AesCmacKey) {
      return PrfMac.create((AesCmacKey) entry.getKey());
    }
    throw new GeneralSecurityException("Could not create primitive for key " + entry.getKey());
  }
  ...
  public void testComputeVerifyMac_works() throws Exception {
    ...
    KeysetHandle smallKeysetHandle =
        KeysetHandle.newBuilder()
            ...
            .build();
    Mac mac = WrappedMac.create(smallKeysetHandle, WrappedMacTest::primitiveFactory);
  ...
  public void testComputeVerifyMac_throwsOnWrongKey() throws Exception {
    ...
    KeysetHandle verifyKeysetHandle =
        KeysetHandle.newBuilder()
            ...
            .build();
    Mac computingMac = WrappedMac.create(computeKeysetHandle, WrappedMacTest::primitiveFactory);
    Mac verifyingMac = WrappedMac.create(verifyKeysetHandle, WrappedMacTest::primitiveFactory);
  ...
  public void testVerifyMac_checksRawKeysWhenTagHasTinkKeyPrefix() throws Exception {
    ...
    Mac mac = WrappedMac.create(verifyKeysetHandle, WrappedMacTest::primitiveFactory);
  ...
  public void computeMac_usesPrimaryKey() throws Exception {
    ...
    KeysetHandle keysetHandlePrimary =
        KeysetHandle.newBuilder()
            .addEntry(KeysetHandle.importKey(rawKey2).withFixedId(1236).makePrimary())
            .build();
    Mac computingMac = WrappedMac.create(keysetHandle, WrappedMacTest::primitiveFactory);
    Mac verifyingMac = WrappedMac.create(keysetHandlePrimary, WrappedMacTest::primitiveFactory);
  ...
  public void testComputeVerifyMac_manyKeysWork() throws Exception {
    ...
    KeysetHandle assortedKeysetHandle =
        KeysetHandle.newBuilder()
            ...
            .build();
    Mac mac = WrappedMac.create(assortedKeysetHandle, WrappedMacTest::primitiveFactory);
  ...
  public void testVerifyMac_shiftedPrimaryWithManyKeysWorks() throws Exception {
    ...
    Mac mac = WrappedMac.create(assortedKeysetHandle1, WrappedMacTest::primitiveFactory);
    ...
    Mac tinkKey0DisabledMac =
        WrappedMac.create(
            KeysetHandle.newBuilder()
                ...
                .build(),
            WrappedMacTest::primitiveFactory);
  ...
  public void testMultipleKeysWithoutAnnotation() throws Exception {
    ...
    KeysetHandle missingKeyKeyset =
        KeysetHandle.newBuilder()
            ...
            .build();
    Mac mac = WrappedMac.create(mainKeysetHandle, WrappedMacTest::primitiveFactory);
    Mac noPrefixMac = WrappedMac.create(noPrefixKeyKeyset, WrappedMacTest::primitiveFactory);
    Mac prefixedMac = WrappedMac.create(prefixedKeyKeyset, WrappedMacTest::primitiveFactory);
    Mac missingMac = WrappedMac.create(missingKeyKeyset, WrappedMacTest::primitiveFactory);
  ...
  public void testWithAnnotation_hasMonitoring() throws Exception {
    ...
    KeysetHandle mixedKeysetHandle =
        KeysetHandle.newBuilder()
            ...
            .addAnnotations(MonitoringAnnotations.class, annotations)
            .build();
    Mac rawMac = WrappedMac.create(rawKeysetHandle, WrappedMacTest::primitiveFactory);
    Mac legacyMac = WrappedMac.create(legacyKeysetHandle, WrappedMacTest::primitiveFactory);
    Mac mac = WrappedMac.create(mixedKeysetHandle, WrappedMacTest::primitiveFactory);
    ...
    assertThat(legacyComputeEntry.getAnnotations()).isEqualTo(annotations);
    ...
    assertThat(tinkVerifyEntry.getAnnotations()).isEqualTo(annotations);
    ...
    assertThat(rawVerifyEntry.getAnnotations()).isEqualTo(annotations);
    ...
    assertThat(legacyVerifyEntry.getAnnotations()).isEqualTo(annotations);
  ...
  private static Mac primitiveFactoryForAlwaysFailing(KeysetHandleInterface.Entry entry)
      throws GeneralSecurityException {
    return new AlwaysFailingMac();
  }
  ...
  public void testAlwaysFailingWithAnnotation_hasMonitoring() throws Exception {
    ...
    KeysetHandle keysetHandle =
        KeysetHandle.newBuilder()
            ...
            .addAnnotations(MonitoringAnnotations.class, annotations)
            .build();
    Mac mac = WrappedMac.create(keysetHandle, WrappedMacTest::primitiveFactoryForAlwaysFailing);
