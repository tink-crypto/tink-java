...
public class MacConfigurationV1Test {
  @Test
  public void config_throwsIfInFipsMode() throws Exception {
    Assume.assumeTrue(TinkFipsUtil.useOnlyFips());

    assertThrows(GeneralSecurityException.class, MacConfigurationV1::get);
  }
  ...
  public void config_containsHmacForMac() throws Exception {
    ...
    assertThat(keysetHandle.getPrimitive(MacConfigurationV1.get(), Mac.class)).isNotNull();
  }
  ...
  public void config_containsHmacForChunkedMac() throws Exception {
    ...
    assertThat(keysetHandle.getPrimitive(MacConfigurationV1.get(), ChunkedMac.class)).isNotNull();
  }
  ...
  public void config_disallowsNon32ByteAesCmacKeyForMac() throws Exception {
    ...
    assertThrows(
        ...
        () -> keysetHandle.getPrimitive(MacConfigurationV1.get(), Mac.class));
  }
  ...
  public void config_disallowsNon32ByteAesCmacKeyForChunkedMac() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> keysetHandle.getPrimitive(MacConfigurationV1.get(), ChunkedMac.class));
  }
}
