...
/** Unit tests for {@link HpkeDecrypt}. */
@RunWith(Theories.class)
@LowLevelCryptoCaller
public final class HpkeDecryptTest {
  ...
  @Test
  public void create_nullPrivateKey_throws() {
    assertThrows(NullPointerException.class, () -> HpkeDecrypt.create(null));
  }
  ...
  public void encryptThenDecryptMessage_works(@FromDataPoints("testVectors") HybridTestVector v)
    ...
    HybridDecrypt hybridDecrypt = HpkeDecrypt.create((HpkePrivateKey) v.getPrivateKey());
    HybridEncrypt hpkeEncrypt =
        HpkeEncrypt.create((HpkePublicKey) v.getPrivateKey().getPublicKey());
    byte[] ciphertext = hpkeEncrypt.encrypt(v.getPlaintext(), v.getContextInfo());
