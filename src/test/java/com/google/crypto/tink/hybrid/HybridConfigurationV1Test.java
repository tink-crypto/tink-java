...
public class HybridConfigurationV1Test {
  @BeforeClass
  ...
  public void config_throwsIfInFipsMode() throws Exception {
    ...
    assertThrows(GeneralSecurityException.class, HybridConfigurationV1::get);
  }
  ...
  public void config_containsEciesAeadHkdfForHybridEncrypt() throws Exception {
    ...
    assertThat(keysetHandle.getPrimitive(HybridConfigurationV1.get(), HybridEncrypt.class))
        .isNotNull();
  }
  ...
  public void config_containsEciesAeadHkdfForHybridDecrypt() throws Exception {
    ...
    assertThat(keysetHandle.getPrimitive(HybridConfigurationV1.get(), HybridDecrypt.class))
        .isNotNull();
  }
  ...
  public void decryptCiphertextWorks(@FromDataPoints("hybridTests") HybridTestVector v)
    ...
    HybridDecrypt hybridDecrypt =
        handle.getPrimitive(HybridConfigurationV1.get(), HybridDecrypt.class);
