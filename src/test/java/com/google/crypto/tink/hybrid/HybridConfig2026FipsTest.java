...
/**
 * Tests for {@link HybridConfig2026} which run under FIPS mode.
 *
 ...
 * </ul>
 *
 * <p>Since {@link HybridConfig2026} contains no FIPS-compliant algorithms, in FIPS mode {@code
 * HybridConfig2026.get()} returns an empty configuration rather than throwing an exception. Unlike
 * full FIPS tests (e.g. {@code AeadConfig2026FipsTest} or {@code MacConfig2026FipsTest}), we only
 * need to test this basic behavior here.
 */
@RunWith(JUnit4.class)
public final class HybridConfig2026FipsTest {
  ...
  public void get_returnsEmptyConfigurationInFipsMode() throws Exception {
    ...
    assertThrows(
        ...
        () -> KeysetHandle.generateNew(parameters, HybridConfig2026.get()));
  }
}
