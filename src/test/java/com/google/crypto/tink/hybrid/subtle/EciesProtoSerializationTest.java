...
public final class EciesProtoSerializationTest {
  ...
  public void serializeParseParameters(@FromDataPoints("variants") VariantTuple variantTuple)
    ...
    ProtoParametersSerialization serialized =
        EciesProtoSerialization.serializeParameters(parameters);
    ...
    Parameters parsed = EciesProtoSerialization.parseParameters(serialization);
  ...
  public void test_demOutputPrefixTypeIsIgnored_whenParsed() throws Exception {
    ...
    EciesParameters parsed = EciesProtoSerialization.parseParameters(serialization);
  ...
  public void parseInvalidParameters_fails(
    ...
    assertThrows(
        ...
        () -> EciesProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void serializeParsePublicKey_p256_tink_equal() throws Exception {
    ...
    // Comparison
    Key parsed = EciesProtoSerialization.parsePublicKey(serialization, /* access= */ null);
    assertThat(parsed.getParameters()).isEqualTo(publicKey.getParameters());
    assertThat(parsed.equalsKey(publicKey)).isTrue();

    ProtoKeySerialization serialized =
        EciesProtoSerialization.serializePublicKey(publicKey, /* access= */ null);
  ...
  public void testParseInvalidPublicKeys_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> EciesProtoSerialization.parsePublicKey(serialization, InsecureSecretKeyAccess.get()));
  }
  ...
  public void serializeParseNistPrivateKey_works() throws Exception {
    ...
    // Comparison
    Key parsed =
        EciesProtoSerialization.parsePrivateKey(serialization, InsecureSecretKeyAccess.get());
    assertThat(parsed.equalsKey(privateKey)).isTrue();

    ProtoKeySerialization serialized =
        EciesProtoSerialization.serializePrivateKey(privateKey, InsecureSecretKeyAccess.get());
  ...
  public void testParsePrivateKey_noAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> EciesProtoSerialization.parsePrivateKey(serialization, /* access= */ null));
  }
  ...
  public void testSerializeKeys_noAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> EciesProtoSerialization.serializePrivateKey(privateKey, /* access= */ null));
  }
