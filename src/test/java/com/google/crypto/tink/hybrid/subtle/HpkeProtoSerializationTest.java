...
public final class HpkeProtoSerializationTest {
  ...
  public void serializeParseParameters(
    ...
    ProtoParametersSerialization serialized =
        HpkeProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(HpkeKeyFormat.parser(), serialized, serialization);

    Parameters parsed = HpkeProtoSerialization.parseParameters(serialization);
  ...
  public void serializeParsePublicKey(
    ...
    Key parsed = HpkeProtoSerialization.parsePublicKey(serialization, /* access= */ null);
    assertThat(parsed.equalsKey(publicKey)).isTrue();

    ProtoKeySerialization serialized =
        HpkeProtoSerialization.serializePublicKey(publicKey, /* access= */ null);
  ...
  public void serializeParsePrivateKey(
    ...
    Key parsed =
        HpkeProtoSerialization.parsePrivateKey(serialization, InsecureSecretKeyAccess.get());
    assertThat(parsed.equalsKey(privateKey)).isTrue();

    ProtoKeySerialization serialized =
        HpkeProtoSerialization.serializePrivateKey(privateKey, InsecureSecretKeyAccess.get());
  ...
  public void parsePrivateKey_noAccess_throws() throws Exception {
    ...
    assertThrows(
        ...
        () -> HpkeProtoSerialization.parsePrivateKey(serialization, /* access= */ null));
  }
  ...
  public void serializePrivateKey_noAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> HpkeProtoSerialization.serializePrivateKey(privateKey, /* access= */ null));
  }
  ...
  public void parseInvalidParameters_fails(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> HpkeProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void parseInvalidPublicKeys_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> HpkeProtoSerialization.parsePublicKey(serialization, /* access= */ null));
  }
  ...
  public void parseParameters_xwingWithUnsupportedKdf_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> HpkeProtoSerialization.parseParameters(serialization));
  }
