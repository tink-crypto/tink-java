...
/** Tests for WrappedHybridEncrypt. */
@RunWith(JUnit4.class)
public class WrappedHybridEncryptTest {
  ...
  private static HybridEncrypt primitiveFactory(KeysetHandleInterface.Entry entry)
      throws GeneralSecurityException {
    return HpkeEncrypt.create((HpkePublicKey) entry.getKey());
  }
  ...
  public void encryptNoPrefix_works() throws Exception {
    ...
    HybridEncrypt encrypter =
        WrappedHybridEncrypt.create(
            handle.getPublicKeysetHandle(), WrappedHybridEncryptTest::primitiveFactory);
  ...
  public void monitorsWithAnnotations() throws Exception {
    ...
    HybridEncrypt encrypt =
        WrappedHybridEncrypt.create(publicHandle, WrappedHybridEncryptTest::primitiveFactory);
  ...
  public void monitorsWithAnnotations_multipleEncrypters_works() throws Exception {
    ...
    HybridEncrypt encrypter1 =
        WrappedHybridEncrypt.create(publicHandle1, WrappedHybridEncryptTest::primitiveFactory);
    HybridEncrypt encrypter2 =
        WrappedHybridEncrypt.create(publicHandle2, WrappedHybridEncryptTest::primitiveFactory);
    byte[] message = "data".getBytes(UTF_8);
    byte[] context = "context".getBytes(UTF_8);
  ...
  private static HybridEncrypt failingPrimitiveFactory(KeysetHandleInterface.Entry entry)
      throws GeneralSecurityException {
    return new AlwaysFailingHybridEncrypt();
  }
  ...
  public void testAlwaysFailingPublicKeySignWithAnnotations_hasMonitoring() throws Exception {
    ...
    HybridEncrypt encrypt =
        WrappedHybridEncrypt.create(
            publicHandle, WrappedHybridEncryptTest::failingPrimitiveFactory);
