...
public class SlhDsaProtoSerializationTest {
  ...
  public void serializeParseParameters_equal(
    ...
    ProtoParametersSerialization serialized =
        SlhDsaProtoSerialization.serializeParameters(pair.parameters);
    Parameters parsed = SlhDsaProtoSerialization.parseParameters(pair.serialization);
  ...
  public void serializeParsePublicKey_equal(
      ...
      throws Exception {
    ProtoKeySerialization serialized = SlhDsaProtoSerialization.serializePublicKey(pair.key, null);
    Key parsed = SlhDsaProtoSerialization.parsePublicKey(pair.serialization, null);
  ...
  public void serializeParsePrivateKey_equal(
    ...
    ProtoKeySerialization serialized =
        SlhDsaProtoSerialization.serializePrivateKey(pair.key, InsecureSecretKeyAccess.get());
    Key parsed =
        SlhDsaProtoSerialization.parsePrivateKey(pair.serialization, InsecureSecretKeyAccess.get());
  ...
  public void serializePrivateKeyWithoutAccess_throws() throws Exception {
    ...
    assertThrows(
        ...
        () -> SlhDsaProtoSerialization.serializePrivateKey(privateKey, /* access= */ null));
  }
  ...
  public void parsePrivateKeyWithoutAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> SlhDsaProtoSerialization.parsePrivateKey(serialization, /* access= */ null));
  }
  ...
  public void parseInvalidParameters_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> SlhDsaProtoSerialization.parseParameters(serialization));
  }
  ...
  public void parseInvalidPublicKeySerialization_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> SlhDsaProtoSerialization.parsePublicKey(serialization, null));
  }
  ...
  public void parseInvalidPrivateKeySerialization_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () ->
            SlhDsaProtoSerialization.parsePrivateKey(serialization, InsecureSecretKeyAccess.get()));
  }
