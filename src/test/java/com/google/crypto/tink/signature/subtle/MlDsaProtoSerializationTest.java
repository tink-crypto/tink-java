...
public class MlDsaProtoSerializationTest {
  ...
  private static final byte[] publicKeyMlDsa44ByteArray = Hex.decode(PUBLIC_KEY_ML_DSA_44_HEX);
  private static final Bytes PUBLIC_KEY_ML_DSA_44_BYTES = Bytes.copyFrom(publicKeyMlDsa44ByteArray);
  private static final ByteString PUBLIC_KEY_ML_DSA_44_BYTE_STRING =
      ByteString.copyFrom(publicKeyMlDsa44ByteArray);

  private static final String PRIVATE_KEY_ML_DSA_44_SEED_HEX =
      "2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a";
  private static final byte[] privateKeyMlDsa44SeedByteArray =
      Hex.decode(PRIVATE_KEY_ML_DSA_44_SEED_HEX);
  private static final SecretBytes PRIVATE_KEY_ML_DSA_44_SEED_SECRET_BYTES =
      SecretBytes.copyFrom(privateKeyMlDsa44SeedByteArray, InsecureSecretKeyAccess.get());
  private static final ByteString PRIVATE_KEY_ML_DSA_44_SEED_BYTE_STRING =
      ByteString.copyFrom(privateKeyMlDsa44SeedByteArray);
  ...
  public void serializeParseParameters_equal(
    ...
    ProtoParametersSerialization serialized =
        MlDsaProtoSerialization.serializeParameters(pair.parameters);
    Parameters parsed = MlDsaProtoSerialization.parseParameters(pair.serialization);
  ...
  public void serializeParsePublicKey_equal(
      ...
      throws Exception {
    ProtoKeySerialization serialized = MlDsaProtoSerialization.serializePublicKey(pair.key, null);
    Key parsed = MlDsaProtoSerialization.parsePublicKey(pair.serialization, null);
  ...
  public void serializeParsePrivateKey_equal(
    ...
    ProtoKeySerialization serialized =
        MlDsaProtoSerialization.serializePrivateKey(pair.key, InsecureSecretKeyAccess.get());
    Key parsed =
        MlDsaProtoSerialization.parsePrivateKey(pair.serialization, InsecureSecretKeyAccess.get());
  ...
  public void serializePrivateKeyWithoutAccess_throws() throws Exception {
    ...
    assertThrows(
        ...
        () -> MlDsaProtoSerialization.serializePrivateKey(privateKey, /* access= */ null));
  }
  ...
  public void parsePrivateKeyWithoutAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> MlDsaProtoSerialization.parsePrivateKey(serialization, /* access= */ null));
  }
  ...
  public void parseInvalidParameters_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> MlDsaProtoSerialization.parseParameters(serialization));
  }

  @Test
  public void parseInvalidParameters_wrongTypeUrl_throws() throws Exception {
    ProtoParametersSerialization serialization =
        ProtoParametersSerialization.create(
            PUBLIC_TYPE_URL,
            OutputPrefixType.RAW,
  ...
  public void parseInvalidPublicKeySerialization_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> MlDsaProtoSerialization.parsePublicKey(serialization, null));
  }

  @Test
  public void parseInvalidPublicKey_wrongTypeUrl_throws() throws Exception {
    ProtoKeySerialization serialization =
        ProtoKeySerialization.create(
            PRIVATE_TYPE_URL,
            com.google.crypto.tink.proto.MlDsaPublicKey.newBuilder()
  ...
  public void parseInvalidPrivateKeySerialization_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () ->
            MlDsaProtoSerialization.parsePrivateKey(serialization, InsecureSecretKeyAccess.get()));
  }

  @Test
  public void parseInvalidPrivateKey_wrongTypeUrl_throws() throws Exception {
    ProtoKeySerialization serialization =
        ProtoKeySerialization.create(
            PUBLIC_TYPE_URL,
            com.google.crypto.tink.proto.MlDsaPrivateKey.newBuilder()
