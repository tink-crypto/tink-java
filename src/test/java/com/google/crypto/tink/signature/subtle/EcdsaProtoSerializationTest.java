...
public final class EcdsaProtoSerializationTest {
    ...
    ProtoParametersSerialization serialization =
        ProtoParametersSerialization.create(
            ...
            com.google.crypto.tink.proto.EcdsaKeyFormat.newBuilder()
                ...
                .build()
                .toByteString());
    ProtoParametersSerialization serialized = EcdsaProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.EcdsaKeyFormat.parser(), serialized, serialization);

    Parameters parsed = EcdsaProtoSerialization.parseParameters(serialization);
  ...
  public void serializeParsePublicKey_p256_tink_equal() throws Exception {
    ...
    Key parsed = EcdsaProtoSerialization.parsePublicKey(serialization, /* access= */ null);
    assertThat(parsed.equalsKey(key)).isTrue();

    ProtoKeySerialization serialized = EcdsaProtoSerialization.serializePublicKey(key, /* access= */ null);
    assertEqualWhenValueParsed(
  ...
  public void parseSerializePublicKey_reencodesNumbersInFixedLengthByteArrays() throws Exception {
    ...
    Key key = EcdsaProtoSerialization.parsePublicKey(serialization, /* access= */ null);
    ProtoKeySerialization serialized = EcdsaProtoSerialization.serializePublicKey((EcdsaPublicKey) key, /* access= */ null);
  ...
  public void serializeParsePrivateKey_p256_tink_equal() throws Exception {
    ...
    Key parsed = EcdsaProtoSerialization.parsePrivateKey(serialization, InsecureSecretKeyAccess.get());
    assertThat(parsed.equalsKey(privateKey)).isTrue();

    ProtoKeySerialization serialized =
        EcdsaProtoSerialization.serializePrivateKey(privateKey, InsecureSecretKeyAccess.get());
  ...
  public void testParsePrivateKey_noAccess_throws() throws Exception {
    ...
    ProtoKeySerialization serialization =
        ProtoKeySerialization.create(
            ...
            /* idRequirement= */ 123);
    assertThrows(
        GeneralSecurityException.class, () -> EcdsaProtoSerialization.parsePrivateKey(serialization, /* access= */ null));
  }
  ...
  public void testSerializeKeys_noAccess_throws() throws Exception {
    ...
    assertThrows(
        ...
        () -> EcdsaProtoSerialization.serializePrivateKey(privateKey, /* access= */ null));
  }
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> EcdsaProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void testParseInvalidPublicKeys_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> EcdsaProtoSerialization.parsePublicKey(serialization, InsecureSecretKeyAccess.get()));
  }

  @Test
  public void testParsePublicKey_wrongTypeUrl_throws() throws Exception {
    String hexX = "60FED4BA255A9D31C961EB74C6356D68C049B8923B61FA6CE669622E60F29FB6";
    String hexY = "7903FE1008B8BC99A41AE9E95628BC64F2F1B20C2D7E9F5177A3C294D4462299";
    ProtoKeySerialization serialization =
        ProtoKeySerialization.create(
  ...
  public void testParseInvalidPrivateKeys_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> EcdsaProtoSerialization.parsePrivateKey(serialization, InsecureSecretKeyAccess.get()));
  }

  @Test
  public void testParsePrivateKey_wrongTypeUrl_throws() throws Exception {
    String hexX = "60FED4BA255A9D31C961EB74C6356D68C049B8923B61FA6CE669622E60F29FB6";
    String hexY = "7903FE1008B8BC99A41AE9E95628BC64F2F1B20C2D7E9F5177A3C294D4462299";
    String hexPrivateValue = "C9AFA9D845BA75166B5C215767B1D6934E50C3DB36E89B127B8A622B120F6721";
    com.google.crypto.tink.proto.EcdsaPublicKey validProtoPublicKey =
