...
/** Unit tests for {@link RsaSsaPkcs1Signer}. */
@RunWith(Theories.class)
@LowLevelCryptoCaller
public final class RsaSsaPkcs1SignerTest {
  @BeforeClass
  ...
  public void testFailIfFipsModuleNotAvailable() throws Exception {
    ...
    assertThrows(
        ...
        () -> RsaSsaPkcs1Signer.create((RsaSsaPkcs1PrivateKey) allTestVectors[0].getPrivateKey()));
  }
  ...
  public void test_computeAndValidateFreshSignatureWithTestVector(
    ...
    PublicKeySign signer =
        RsaSsaPkcs1Signer.create((RsaSsaPkcs1PrivateKey) testVector.getPrivateKey());
