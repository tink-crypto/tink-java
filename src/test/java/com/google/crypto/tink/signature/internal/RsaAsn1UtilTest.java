...
/**
 * Unit tests for {@link RsaAsn1Util}.
 *
...
@AccessesPartialKey
public final class RsaAsn1UtilTest {
  ...
  public void rsaSsaPkcs1PublicKeyToPkcs1Bytes_matchesExpected() throws Exception {
    ...
    byte[] result = RsaAsn1Util.rsaSsaPkcs1PublicKeyToPkcs1Bytes(tinkPublicKey);
  ...
  public void rsaSsaPssPublicKeyToPkcs1Bytes_matchesExpected() throws Exception {
    ...
    byte[] result = RsaAsn1Util.rsaSsaPssPublicKeyToPkcs1Bytes(tinkPublicKey);
  ...
  public void rsaSsaPkcs1PrivateKeyToPkcs1Bytes_matchesExpected() throws Exception {
    ...
    byte[] result = RsaAsn1Util.rsaSsaPkcs1PrivateKeyToPkcs1Bytes(tinkPrivateKey);
  ...
  public void rsaSsaPssPrivateKeyToPkcs1Bytes_matchesExpected() throws Exception {
    ...
    byte[] result = RsaAsn1Util.rsaSsaPssPrivateKeyToPkcs1Bytes(tinkPrivateKey);
  ...
  public void createPrivateKeyInfo_matchesExpectedHardcodedOutput() {
    ...
    byte[] result = RsaAsn1Util.createPrivateKeyInfo(inputPkcs1);
  ...
  public void createPkcs8RsaKeyFromPkcs1RsaKey_matchesExpectedHardcodedOutput() {
    ...
    byte[] result = RsaAsn1Util.createPkcs8RsaKeyFromPkcs1RsaKey(inputPkcs1);
  ...
  public void pkcs1RsaKeyToRsaSsaPssPrivateKey_works() throws Exception {
    ...
    RsaSsaPssPrivateKey parsedKey = RsaAsn1Util.pkcs1RsaKeyToRsaSsaPssPrivateKey(inputPkcs1, params);
  ...
  public void pkcs1RsaKeyToRsaSsaPkcs1PrivateKey_works() throws Exception {
    ...
    RsaSsaPkcs1PrivateKey parsedKey =
        RsaAsn1Util.pkcs1RsaKeyToRsaSsaPkcs1PrivateKey(inputPkcs1, params);
  ...
  public void pkcs1RsaKeyToRsaSsaPssPrivateKey_nonF4Exponent_throws() throws Exception {
    ...
    assertThrows(
        ...
        () -> RsaAsn1Util.pkcs1RsaKeyToRsaSsaPssPrivateKey(nonF4Pkcs1Key, params));
  }
  ...
  public void pkcs1RsaKeyToRsaSsaPkcs1PrivateKey_nonF4Exponent_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> RsaAsn1Util.pkcs1RsaKeyToRsaSsaPkcs1PrivateKey(nonF4Pkcs1Key, params));
  }
}
