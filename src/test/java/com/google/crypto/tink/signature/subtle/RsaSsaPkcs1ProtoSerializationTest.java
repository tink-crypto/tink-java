...
public final class RsaSsaPkcs1ProtoSerializationTest {
  ...
  public void serializeParseParameters_sha256_no_prefix_equal() throws Exception {
    ...
    ProtoParametersSerialization serialized =
        RsaSsaPkcs1ProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.RsaSsaPkcs1KeyFormat.parser(), serialized, serialization);

    Parameters parsed = RsaSsaPkcs1ProtoSerialization.parseParameters(serialization);
  ...
  public void serializePublicParseKey_sha384_no_prefix_equal() throws Exception {
    ...
    Key parsed = RsaSsaPkcs1ProtoSerialization.parsePublicKey(serialization, /* access= */ null);
    assertThat(parsed.equalsKey(key)).isTrue();

    ProtoKeySerialization serialized =
        RsaSsaPkcs1ProtoSerialization.serializePublicKey(key, /* access= */ null);
    assertEqualWhenValueParsed(
  ...
  public void existingTinkKeyset_reencodesNumbersUsingTwoComplement() throws Exception {
    ...
    Key parsed =
        RsaSsaPkcs1ProtoSerialization.parsePrivateKey(
            serializationOfExistingKey, InsecureSecretKeyAccess.get());
    ProtoKeySerialization serialized =
        RsaSsaPkcs1ProtoSerialization.serializePrivateKey(
            (RsaSsaPkcs1PrivateKey) parsed, InsecureSecretKeyAccess.get());
  ...
  public void parsePrivateKey_noAccess_fails() throws Exception {
    ...
    assertThrows(
        ...
        () -> RsaSsaPkcs1ProtoSerialization.parsePrivateKey(serialization, /* access= */ null));
  }
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> RsaSsaPkcs1ProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void testParseInvalidPublicKeys_throws(
    ...
    assertThrows(
        Exception.class,
        () -> RsaSsaPkcs1ProtoSerialization.parsePublicKey(serialization, /* access= */ null));
  }
