...
public final class Ed25519ProtoSerializationTest {
  ...
  public void serializeParseParameters_noPrefix() throws Exception {
    ...
    ProtoParametersSerialization serialized = Ed25519ProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(Ed25519KeyFormat.parser(), serialized, serialization);

    Parameters parsed = Ed25519ProtoSerialization.parseParameters(serialization);
  ...
  public void serializeParsePublicKey_noPrefix() throws Exception {
    ...
    Key parsed = Ed25519ProtoSerialization.parsePublicKey(serialization, InsecureSecretKeyAccess.get());
    assertThat(parsed.equalsKey(publicKey)).isTrue();

    ProtoKeySerialization serialized =
        Ed25519ProtoSerialization.serializePublicKey(publicKey, InsecureSecretKeyAccess.get());
  ...
  public void serializeParsePrivateKey_noPrefix() throws Exception {
    ...
    Key parsed = Ed25519ProtoSerialization.parsePrivateKey(serialization, InsecureSecretKeyAccess.get());
    assertThat(parsed.equalsKey(privateKey)).isTrue();

    ProtoKeySerialization serialized =
        Ed25519ProtoSerialization.serializePrivateKey(privateKey, InsecureSecretKeyAccess.get());
  ...
  public void testParsePrivateKey_noAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class, () -> Ed25519ProtoSerialization.parsePrivateKey(serialization, /* access= */ null));
  }
  ...
  public void testSerializePrivateKey_noAccess_throws() throws Exception {
    ...
    assertThrows(
        ...
        () -> Ed25519ProtoSerialization.serializePrivateKey(privateKey, /* access= */ null));
  }
    ...
    try {
      return new ProtoParametersSerialization[] {
        ...
        ProtoParametersSerialization.create(
            PRIVATE_TYPE_URL,
            OutputPrefixType.RAW,
            Ed25519KeyFormat.newBuilder().setVersion(1).build().toByteString()),
  ...
  public void testParseInvalidParameters_fails(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> Ed25519ProtoSerialization.parseParameters(serializedParameters));
  }
  ...
  public void testParseInvalidPublicKeys_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> Ed25519ProtoSerialization.parsePublicKey(serialization, InsecureSecretKeyAccess.get()));
  }
  ...
  public void testParseInvalidPrivateKeys_throws(
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> Ed25519ProtoSerialization.parsePrivateKey(serialization, InsecureSecretKeyAccess.get()));
  }
