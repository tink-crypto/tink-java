...
public class CompositeMlDsaProtoSerializationTest {
  ...
  private static final class ParametersSerializationTestPair {
    final CompositeMlDsaParameters parameters;
  ...
  public void serializeParseParameters_equal(
    ...
    ProtoParametersSerialization serialized =
        CompositeMlDsaProtoSerialization.serializeParameters(pair.parameters);
    CompositeMlDsaParameters parsed =
        CompositeMlDsaProtoSerialization.parseParameters(pair.serialization);
  ...
  private static final class PublicKeySerializationTestPair {
    final CompositeMlDsaPublicKey key;
  ...
  public void serializeParsePublicKey_equal(
    ...
    ProtoKeySerialization serialized =
        CompositeMlDsaProtoSerialization.serializePublicKey(pair.key, null);
    CompositeMlDsaPublicKey parsed =
        CompositeMlDsaProtoSerialization.parsePublicKey(pair.serialization, null);
  ...
  private static final class PrivateKeySerializationTestPair {
    final CompositeMlDsaPrivateKey key;
    final ProtoKeySerialization serialization;
  ...
  public void serializeParsePrivateKey_equal(
    ...
    ProtoKeySerialization serialized =
        CompositeMlDsaProtoSerialization.serializePrivateKey(
            pair.key, InsecureSecretKeyAccess.get());
    CompositeMlDsaPrivateKey parsed =
        CompositeMlDsaProtoSerialization.parsePrivateKey(
            pair.serialization, InsecureSecretKeyAccess.get());
  ...
  public void serializePrivateKeyWithoutAccess_throws() throws Exception {
    ...
    assertThrows(
        ...
        () -> CompositeMlDsaProtoSerialization.serializePrivateKey(privateKey, /* access= */ null));
  }
  ...
  public void parsePrivateKeyWithoutAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> CompositeMlDsaProtoSerialization.parsePrivateKey(serialization, /* access= */ null));
  }
  ...
  public void parseInvalidParameters_throws(
      ...
      throws Exception {
    assertThrows(
        Exception.class, () -> CompositeMlDsaProtoSerialization.parseParameters(serialization));
  }
  ...
  public void parseInvalidPublicKeySerialization_throws(
    ...
    assertThrows(
        Exception.class,
        () -> CompositeMlDsaProtoSerialization.parsePublicKey(serialization, access));
  }
  ...
  public void parseInvalidPrivateKeySerialization_throws(
    ...
    assertThrows(
        Exception.class,
        () -> CompositeMlDsaProtoSerialization.parsePrivateKey(serialization, access));
  }
}
