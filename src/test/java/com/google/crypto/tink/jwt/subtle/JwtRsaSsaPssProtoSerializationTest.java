...
public final class JwtRsaSsaPssProtoSerializationTest {
  ...
  public void serializeParseParameters_kidStrategyIgnored_works(
    ...
    ProtoParametersSerialization serialized =
        JwtRsaSsaPssProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(JwtRsaSsaPssKeyFormat.parser(), serialized, serialization);

    Parameters parsed = JwtRsaSsaPssProtoSerialization.parseParameters(serialization);
  ...
  public void parseParameters_crunchy_cannotBeParsed_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> JwtRsaSsaPssProtoSerialization.parseParameters(serialization));
  }
  ...
  public void serializeParsePublicKey_kidIgnored_equal(
    ...
    Key parsed = JwtRsaSsaPssProtoSerialization.parsePublicKey(serialization, /* access= */ null);
    assertThat(parsed.equalsKey(key)).isTrue();

    ProtoKeySerialization serialized =
        JwtRsaSsaPssProtoSerialization.serializePublicKey(key, /* access= */ null);
  ...
  public void parsePublicKey_crunchy_cannotBeParsed_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> JwtRsaSsaPssProtoSerialization.parsePublicKey(serialization, /* access= */ null));
  }
  ...
  public void serializePrivateKey_noSecretKeyAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> JwtRsaSsaPssProtoSerialization.serializePrivateKey(privateKey, /* access= */ null));
  }
  ...
  public void parsePrivateKey_noSecretKeyAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> JwtRsaSsaPssProtoSerialization.parsePrivateKey(serialization, /* access= */ null));
  }
}
