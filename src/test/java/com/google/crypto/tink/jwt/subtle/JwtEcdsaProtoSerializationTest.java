...
public final class JwtEcdsaProtoSerializationTest {
  ...
  public void serializeParseParameters_kidStrategyIsIgnored_works() throws Exception {
    ...
    ProtoParametersSerialization serialized =
        JwtEcdsaProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(
        com.google.crypto.tink.proto.JwtEcdsaKeyFormat.parser(), serialized, serialization);

    Parameters parsed = JwtEcdsaProtoSerialization.parseParameters(serialization);
  ...
  public void parseParameters_crunchy_cannotBeParsed_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> JwtEcdsaProtoSerialization.parseParameters(serialization));
  }
  ...
  public void serializeParsePublicKey_es256_kidIgnored_equal() throws Exception {
    ...
    JwtEcdsaPublicKey parsed =
        JwtEcdsaProtoSerialization.parsePublicKey(serialization, /* access= */ null);
    assertThat(parsed.equalsKey(key)).isTrue();

    ProtoKeySerialization serialized =
        JwtEcdsaProtoSerialization.serializePublicKey(key, /* access= */ null);
    assertEqualWhenValueParsed(
  ...
  public void serializeParsePrivateKey_es256_kidIgnored_equal() throws Exception {
    ...
    JwtEcdsaPrivateKey parsed =
        JwtEcdsaProtoSerialization.parsePrivateKey(serialization, InsecureSecretKeyAccess.get());
    assertThat(parsed.equalsKey(privateKey)).isTrue();

    ProtoKeySerialization serialized =
        JwtEcdsaProtoSerialization.serializePrivateKey(privateKey, InsecureSecretKeyAccess.get());
    assertEqualWhenValueParsed(
  ...
  public void serialize_noSecretKeyAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> JwtEcdsaProtoSerialization.serializePrivateKey(privateKey, /* access= */ null));
  }
  ...
  public void parse_noSecretKeyAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> JwtEcdsaProtoSerialization.parsePrivateKey(serialization, /* access= */ null));
  }
}
