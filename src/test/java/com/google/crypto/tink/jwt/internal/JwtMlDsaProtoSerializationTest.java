...
public final class JwtMlDsaProtoSerializationTest {
  ...
  // TODO: b/508561242 - Replace random key material with valid ML-DSA keys.
  private static final Bytes ML_DSA44_PUBLIC_KEY_BYTES =
      Bytes.copyFrom(Random.randBytes(getPublicKeySize(JwtMlDsaParameters.Algorithm.ML_DSA_44)));
  private static final SecretBytes ML_DSA44_PRIVATE_KEY_BYTES = SecretBytes.randomBytes(32);
  private static final Bytes ML_DSA65_PUBLIC_KEY_BYTES =
      Bytes.copyFrom(Random.randBytes(getPublicKeySize(JwtMlDsaParameters.Algorithm.ML_DSA_65)));
  private static final SecretBytes ML_DSA65_PRIVATE_KEY_BYTES = SecretBytes.randomBytes(32);
  private static final Bytes ML_DSA87_PUBLIC_KEY_BYTES =
      Bytes.copyFrom(Random.randBytes(getPublicKeySize(JwtMlDsaParameters.Algorithm.ML_DSA_87)));
  private static final SecretBytes ML_DSA87_PRIVATE_KEY_BYTES = SecretBytes.randomBytes(32);
