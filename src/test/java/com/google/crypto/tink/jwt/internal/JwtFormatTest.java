...
public final class JwtFormatTest {
  ...
  public void validateHeaderWithWrongAlgorithm_fails() throws Exception {
    ...
    assertThrows(
        ...
        () ->
            JwtFormat.validateHeader(
                JsonUtil.parseJson(header), "HS384", Optional.empty(), true));
  }
  ...
  public void validateEmptyHeader_fails() throws Exception {
    assertThrows(
        ...
        () ->
            JwtFormat.validateHeader(
                JsonUtil.parseJson("{}"), "HS256", Optional.empty(), true));
  }

  @Test
  public void validateHeaderWithKidRequired() throws Exception {
    JwtFormat.validateHeader(
        JsonUtil.parseJson("{\"alg\": \"HS256\", \"kid\": \"kid123\"}"),
        "HS256",
        Optional.of("kid123"),
        /*allowKidAbsent=*/ false);
    assertThrows(
        JwtInvalidException.class,
        () ->
            JwtFormat.validateHeader(
                ...
                Optional.of("kid123"),
                /*allowKidAbsent=*/ false));
    // If kid is required (allowKidAbsent=false), then the kid is required in the header.
    assertThrows(
        JwtInvalidException.class,
        () ->
            JwtFormat.validateHeader(
  ...
  @Test
  public void validateHeaderWithKidOptional() throws Exception {
    JwtFormat.validateHeader(
        JsonUtil.parseJson("{\"alg\": \"HS256\", \"kid\": \"kid123\"}"),
        "HS256",
        Optional.of("kid123"),
    ...
    assertThrows(
        ...
        () ->
            JwtFormat.validateHeader(
                ...
                Optional.of("kid123"),
                /*allowKidAbsent=*/ true));
    // If kid is optional (allowKidAbsent=true), then the kid is not required in the header.
    JwtFormat.validateHeader(
        JsonUtil.parseJson("{\"alg\": \"HS256\"}"),
        "HS256",
        Optional.of("kid123"),
  ...
  public void splitSignedCompactWithBadFormat_fails() throws Exception {
    assertThrows(JwtInvalidException.class, () -> JwtFormat.splitSignedCompact("e30.e30.YWJj.abc"));
    ...
    assertThrows(JwtInvalidException.class, () -> JwtFormat.splitSignedCompact("e30.e30"));
    assertThrows(JwtInvalidException.class, () -> JwtFormat.splitSignedCompact("e30"));
    assertThrows(JwtInvalidException.class, () -> JwtFormat.splitSignedCompact(""));
  }
