...
public final class JwtEcdsaPublicKeyTest {
  ...
  public void build_kidStrategyIgnored_getProperties_es256() throws Exception {
    ...
    EcdsaPublicKey ecdsaPublicKey = key.getEcdsaPublicKey();
    assertThat(ecdsaPublicKey.getPublicPoint()).isEqualTo(A_P256_POINT);
    assertThat(ecdsaPublicKey.getParameters())
        .isEqualTo(
  ...
  public void build_kidStrategyIgnored_andGetProperties_es384() throws Exception {
    ...
    EcdsaPublicKey ecdsaPublicKey = key.getEcdsaPublicKey();
    assertThat(ecdsaPublicKey.getPublicPoint()).isEqualTo(A_P384_POINT);
    assertThat(ecdsaPublicKey.getParameters())
        .isEqualTo(
            EcdsaParameters.builder()
                .setVariant(EcdsaParameters.Variant.NO_PREFIX)
  ...
  public void build_kidStrategyIgnored_andGetProperties_es512() throws Exception {
    ...
    EcdsaPublicKey ecdsaPublicKey = key.getEcdsaPublicKey();
    assertThat(ecdsaPublicKey.getPublicPoint()).isEqualTo(A_P521_POINT);
    assertThat(ecdsaPublicKey.getParameters())
        .isEqualTo(
            EcdsaParameters.builder()
                .setVariant(EcdsaParameters.Variant.NO_PREFIX)
