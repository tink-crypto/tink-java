...
import com.google.crypto.tink.jwt.JwtRsaSsaPkcs1Parameters.Algorithm;
...
public final class JwtRsaSsaPkcs1ProtoSerializationTest {
  ...
  private static final class AlgorithmTuple {
    ...
    AlgorithmTuple(Algorithm algorithm, JwtRsaSsaPkcs1Algorithm protoAlgorithm) {
  ...
  public void serializeParseParameters_kidStrategyIgnored_works(
    ...
    ProtoParametersSerialization serialized =
        JwtRsaSsaPkcs1ProtoSerialization.serializeParameters(parameters);
    assertEqualWhenValueParsed(JwtRsaSsaPkcs1KeyFormat.parser(), serialized, serialization);

    Parameters parsed = JwtRsaSsaPkcs1ProtoSerialization.parseParameters(serialization);
  ...
  public void parseParameters_crunchy_cannotBeParsed_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> JwtRsaSsaPkcs1ProtoSerialization.parseParameters(serialization));
  }
  ...
  public void serializeParsePublicKey_kidIgnored_equal(
    ...
    Key parsed = JwtRsaSsaPkcs1ProtoSerialization.parsePublicKey(serialization, /* access= */ null);
    assertThat(parsed.equalsKey(key)).isTrue();

    ProtoKeySerialization serialized =
        JwtRsaSsaPkcs1ProtoSerialization.serializePublicKey(key, /* access= */ null);
  ...
  public void parsePublicKey_crunchy_cannotBeParsed_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> JwtRsaSsaPkcs1ProtoSerialization.parsePublicKey(serialization, /* access= */ null));
  }
  ...
  public void serializePrivateKey_noSecretKeyAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> JwtRsaSsaPkcs1ProtoSerialization.serializePrivateKey(privateKey, /* access= */ null));
  }
  ...
  public void parsePrivateKey_noSecretKeyAccess_throws() throws Exception {
    ...
    assertThrows(
        GeneralSecurityException.class,
        () -> JwtRsaSsaPkcs1ProtoSerialization.parsePrivateKey(serialization, /* access= */ null));
  }
}
