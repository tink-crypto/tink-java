...
public final class AesSivProtoSerialization {
  ...
  private static final ParametersSerializer<AesSivParameters>
      PARAMETERS_SERIALIZER =
          ParametersSerializer.create(
              AesSivProtoSerialization::serializeParameters, AesSivParameters.class);

  private static final ParametersParser PARAMETERS_PARSER =
      ParametersParser.create(AesSivProtoSerialization::parseParameters, TYPE_URL);
  ...
  private static final KeyParser KEY_PARSER =
      KeyParser.create(AesSivProtoSerialization::parseKey, TYPE_URL);
