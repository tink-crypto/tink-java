...
/** Provides an {@link HybridDecrypt} from an {@link EciesPrivateKey}. */
public final class EciesDecrypt {

  private EciesDecrypt() {}
  ...
  public static HybridDecrypt create(EciesPrivateKey key) throws GeneralSecurityException {
    return EciesAeadHkdfHybridDecrypt.create(key);
  }
}
