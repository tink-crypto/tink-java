...
/** Provides an {@link HybridEncrypt} from an {@link EciesPublicKey}. */
public final class EciesEncrypt {

  private EciesEncrypt() {}
  ...
  public static HybridEncrypt create(EciesPublicKey key) throws GeneralSecurityException {
    return EciesAeadHkdfHybridEncrypt.create(key);
  }
}
