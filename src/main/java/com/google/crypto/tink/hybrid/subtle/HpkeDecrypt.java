...
/** Provides a {@link HybridDecrypt} from an {@link HpkePrivateKey}. */
public final class HpkeDecrypt {
  ...
  public static HybridDecrypt create(HpkePrivateKey key) throws GeneralSecurityException {
    return com.google.crypto.tink.hybrid.internal.HpkeDecrypt.create(key);
  }
