...
/** Public Proto Serialization for {@link AesCmacKey} and {@link AesCmacParameters}. */
@AccessesPartialKey
public final class AesCmacProtoSerialization {
  ...
  public static ProtoParametersSerialization serializeParameters(AesCmacParameters parameters)
    ...
    return com.google.crypto.tink.mac.internal.AesCmacProtoSerialization.serializeParameters(
        parameters);
  }
  ...
  public static ProtoKeySerialization serializeKey(AesCmacKey key, @Nullable SecretKeyAccess access)
      throws GeneralSecurityException {
    return com.google.crypto.tink.mac.internal.AesCmacProtoSerialization.serializeKey(key, access);
  }
  ...
  public static AesCmacParameters parseParameters(ProtoParametersSerialization serialization)
      throws GeneralSecurityException {
    return com.google.crypto.tink.mac.internal.AesCmacProtoSerialization.parseParameters(
        serialization);
  }
  ...
  public static AesCmacKey parseKey(
      ...
      throws GeneralSecurityException {
    return com.google.crypto.tink.mac.internal.AesCmacProtoSerialization.parseKey(
