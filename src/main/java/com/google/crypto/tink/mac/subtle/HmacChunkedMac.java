...
/**
 * Provides a {@link ChunkedMac} from an {@link HmacKey}.
 */
public final class HmacChunkedMac {
  ...
  public static ChunkedMac create(HmacKey key) throws GeneralSecurityException {
    return new ChunkedHmacImpl(key);
  }

  private HmacChunkedMac() {}
}
