...
/**
 * Provides a {@link StreamingAead} from an {@link AesCtrHmacStreamingKey}.
 *
 * <p>Historical note: this should be preferred over the similar class in {@link
 * com.google.crypto.tink.subtle.AesCtrHmacStreaming}: we plan to standardize the API surface for
 * primitives from single keys with classes in {@code
 * com.google.crypto.tink.<primitive>.subtle.ClassName}.
 */
public final class AesCtrHmacStreamingAead {
  ...
  public static StreamingAead create(AesCtrHmacStreamingKey key) throws GeneralSecurityException {
    return AesCtrHmacStreaming.create(key);
  }

  private AesCtrHmacStreamingAead() {}
}
