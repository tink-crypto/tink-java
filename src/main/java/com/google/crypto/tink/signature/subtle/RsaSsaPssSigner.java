...
/**
 * Provides a {@link PublicKeySign} from an {@link RsaSsaPssPrivateKey}.
 *
 * <p>Historical note: this should be prefered over the similar class in {@link
 * com.google.crypto.tink.subtle.RsaSsaPssSignJce}: we plan to standardize the API surface for
 * primitives from single keys with classes in {@code
 * com.google.crypto.tink.<primitive>.subtle.ClassName}.
 */
public final class RsaSsaPssSigner {
  ...
  public static PublicKeySign create(RsaSsaPssPrivateKey key) throws GeneralSecurityException {
    return RsaSsaPssSignJce.create(key);
  }

  private RsaSsaPssSigner() {}
}
