...
/**
 * Provides a {@link PublicKeyVerify} from an {@link RsaSsaPssPublicKey}.
 *
 * <p>Historical note: this should be prefered over the similar class in {@link
 * com.google.crypto.tink.subtle.RsaSsaPssVerifyJce}: we plan to standardize the API surface for
 * primitives from single keys with classes in {@code
 * com.google.crypto.tink.<primitive>.subtle.ClassName}.
 */
public final class RsaSsaPssVerifier {
  ...
  public static PublicKeyVerify create(RsaSsaPssPublicKey key) throws GeneralSecurityException {
    return RsaSsaPssVerifyJce.create(key);
  }

  private RsaSsaPssVerifier() {}
}
