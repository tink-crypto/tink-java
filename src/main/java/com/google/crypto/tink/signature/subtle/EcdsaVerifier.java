...
/**
 * Provides a {@link PublicKeyVerify} from an {@link EcdsaPublicKey}.
 *
 * <p>Historical note: this should be prefered over the similar class in {@link
 * com.google.crypto.tink.subtle.EcdsaVerifyJce}: we plan to standardize the API surface for
...
public final class EcdsaVerifier {
  ...
  public static PublicKeyVerify create(EcdsaPublicKey key) throws GeneralSecurityException {
    return EcdsaVerifyJce.create(key);
  }
