...
/**
 * Methods to serialize and parse {@link MlDsaPrivateKey}, {@link MlDsaPublicKey}, and {@link
 * MlDsaParameters} objects.
 */
@AccessesPartialKey
public final class MlDsaProtoSerialization {
  ...
  public static ProtoParametersSerialization serializeParameters(MlDsaParameters parameters)
    ...
    return com.google.crypto.tink.signature.internal.MlDsaProtoSerialization.serializeParameters(
        parameters);
  }
  ...
  public static ProtoKeySerialization serializePublicKey(
    ...
    return com.google.crypto.tink.signature.internal.MlDsaProtoSerialization.serializePublicKey(
        key, access);
  }
  ...
  public static ProtoKeySerialization serializePrivateKey(
    ...
    return com.google.crypto.tink.signature.internal.MlDsaProtoSerialization.serializePrivateKey(
        key, access);
  }
  ...
  public static MlDsaParameters parseParameters(ProtoParametersSerialization serialization)
      throws GeneralSecurityException {
    return com.google.crypto.tink.signature.internal.MlDsaProtoSerialization.parseParameters(
        serialization);
  }
  ...
  public static MlDsaPublicKey parsePublicKey(
      ...
      throws GeneralSecurityException {
    return com.google.crypto.tink.signature.internal.MlDsaProtoSerialization.parsePublicKey(
  ...
  public static MlDsaPrivateKey parsePrivateKey(
      ProtoKeySerialization serialization, @Nullable SecretKeyAccess access)
      throws GeneralSecurityException {
    return com.google.crypto.tink.signature.internal.MlDsaProtoSerialization.parsePrivateKey(
        serialization, access);
  }
}
