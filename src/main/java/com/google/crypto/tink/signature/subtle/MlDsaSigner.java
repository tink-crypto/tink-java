...
public final class MlDsaSigner {
  ...
  public static PublicKeySign create(MlDsaPrivateKey key) throws GeneralSecurityException {
    return MlDsaSignConscrypt.create(key);
  }
