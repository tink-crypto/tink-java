...
/** Provides a {@link PublicKeyVerify} from a {@link CompositeMlDsaPublicKey}. */
public final class CompositeMlDsaVerifier {
  ...
  public static PublicKeyVerify create(CompositeMlDsaPublicKey key)
      throws GeneralSecurityException {
    return CompositeMlDsaVerifyConscrypt.create(key);
  }

  private CompositeMlDsaVerifier() {}
}
