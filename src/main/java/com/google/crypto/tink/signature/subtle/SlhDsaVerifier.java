...
/** Provides a {@link PublicKeyVerify} from an {@link SlhDsaPublicKey}. */
public final class SlhDsaVerifier {
  ...
  public static PublicKeyVerify create(SlhDsaPublicKey key) throws GeneralSecurityException {
    return SlhDsaVerifyConscrypt.create(key);
  }

  private SlhDsaVerifier() {}
}
