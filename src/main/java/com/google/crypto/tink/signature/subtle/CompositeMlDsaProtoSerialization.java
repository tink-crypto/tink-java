...
/**
 * Methods to serialize and parse {@link CompositeMlDsaPrivateKey}, {@link CompositeMlDsaPublicKey},
 * and {@link CompositeMlDsaParameters} objects.
 */
@AccessesPartialKey
public final class CompositeMlDsaProtoSerialization {
  ...
  public static ProtoParametersSerialization serializeParameters(
    ...
    return com.google.crypto.tink.signature.internal.CompositeMlDsaProtoSerialization
  ...
  public static CompositeMlDsaPublicKey parsePublicKey(
      ...
      throws GeneralSecurityException {
    return com.google.crypto.tink.signature.internal.CompositeMlDsaProtoSerialization
        .parsePublicKey(serialization, access);
  }
