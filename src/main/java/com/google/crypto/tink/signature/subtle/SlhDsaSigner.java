...
/** Provides a {@link PublicKeySign} from an {@link SlhDsaPrivateKey}. */
public final class SlhDsaSigner {
  ...
  public static PublicKeySign create(SlhDsaPrivateKey key) throws GeneralSecurityException {
    return SlhDsaSignConscrypt.create(key);
  }

  private SlhDsaSigner() {}
}
