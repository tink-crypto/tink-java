...
import com.google.crypto.tink.signature.internal.RsaSsaPkcs1SignJce;
import com.google.errorprone.annotations.RestrictedApi;
import java.security.GeneralSecurityException;

/**
 * Provides a {@link PublicKeySign} from an {@link RsaSsaPkcs1PrivateKey}.
 *
 * <p>Historical note: this should be prefered over the similar class in {@link
 * com.google.crypto.tink.signature.internal.RsaSsaPkcs1SignJce}: we plan to standardize the API
 * surface for primitives from single keys with classes in {@code
 * com.google.crypto.tink.<primitive>.subtle.ClassName}.
 */
public final class RsaSsaPkcs1Signer {
