...
/**
 * Provides a {@link PublicKeyVerify} from an {@link MlDsaPublicKey}.
 *
 * <p>Historical note: this should be preferred over the similar class in {@link
 * com.google.crypto.tink.signature.internal.MlDsaVerifyConscrypt}: we plan to standardize the API
 * surface for primitives from single keys with classes in {@code
 * com.google.crypto.tink.<primitive>.subtle.ClassName}.
 */
public final class MlDsaVerifier {
  ...
  public static PublicKeyVerify create(MlDsaPublicKey key) throws GeneralSecurityException {
    return MlDsaVerifyConscrypt.create(key);
  }

  private MlDsaVerifier() {}
}
