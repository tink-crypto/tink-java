 ...
 * keysetHandle.getPrimitive(RegistryConfiguration.get(), PublicKeyVerify.class)} instead. The
 ...
 *     PublicKeyVerify.class)} after registering the {@code PublicKeyVerifyWrapper} instead.
 * @since 1.0.0
 */
@Deprecated
