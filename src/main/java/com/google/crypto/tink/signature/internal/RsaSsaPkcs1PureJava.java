...
/**
 * Pure Java implementation of RSA-PKCS1.5 signature verification.
 */
@Immutable
public final class RsaSsaPkcs1PureJava implements PublicKeyVerify {
  ...
  public static PublicKeyVerify create(RsaSsaPkcs1PublicKey key) throws GeneralSecurityException {
    ...
    return new RsaSsaPkcs1PureJava(
        publicKey,
