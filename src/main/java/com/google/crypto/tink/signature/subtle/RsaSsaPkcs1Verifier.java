...
/**
 * Provides a {@link PublicKeyVerify} from an {@link RsaSsaPkcs1PublicKey}.
 *
 * <p>Historical note: this should be prefered over the similar class in {@link
 * com.google.crypto.tink.subtle.RsaSsaPkcs1VerifyJce}: we plan to standardize the API surface for
 * primitives from single keys with classes in {@code
 * com.google.crypto.tink.<primitive>.subtle.ClassName}.
 */
public final class RsaSsaPkcs1Verifier {
