...
public final class JwtRsaSsaPkcs1ProtoSerialization {
  ...
  private static final ParametersSerializer<JwtRsaSsaPkcs1Parameters>
  ...
  private static final ParametersParser PARAMETERS_PARSER =
      ParametersParser.create(JwtRsaSsaPkcs1ProtoSerialization::parseParameters, PRIVATE_TYPE_URL);
  ...
  private static final KeyParser PUBLIC_KEY_PARSER =
      KeyParser.create(JwtRsaSsaPkcs1ProtoSerialization::parsePublicKey, PUBLIC_TYPE_URL);
  ...
  private static final KeyParser PRIVATE_KEY_PARSER =
      KeyParser.create(JwtRsaSsaPkcs1ProtoSerialization::parsePrivateKey, PRIVATE_TYPE_URL);
