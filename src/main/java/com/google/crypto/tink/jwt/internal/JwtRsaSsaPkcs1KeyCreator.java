...
/** Creates RSA-SSA-PKCS1 keys for JWT. */
public final class JwtRsaSsaPkcs1KeyCreator {

  @AccessesPartialKey
  public static JwtRsaSsaPkcs1PrivateKey createKey(
  ...
  private JwtRsaSsaPkcs1KeyCreator() {}
}
