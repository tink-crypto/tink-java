...
/** An implementation of {@link JwtPublicKeySign} for ML-DSA. */
@SuppressWarnings("Immutable")
public final class JwtMlDsaPublicKeySign implements JwtPublicKeySign {
  private final JwtMlDsaPrivateKey privateKey;
  private final PublicKeySign signer;
  private final String algorithm;

  private JwtMlDsaPublicKeySign(
      JwtMlDsaPrivateKey privateKey, PublicKeySign signer, String algorithm) {
  ...
  @AccessesPartialKey
  public static JwtPublicKeySign create(JwtMlDsaPrivateKey privateKey)
      throws GeneralSecurityException {
    return new JwtMlDsaPublicKeySign(
        privateKey,
        MlDsaSignConscrypt.create(privateKey.getMlDsaPrivateKey()),
