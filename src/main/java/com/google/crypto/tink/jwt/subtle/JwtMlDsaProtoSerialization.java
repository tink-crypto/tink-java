...
public final class JwtMlDsaProtoSerialization {
  ...
  public static ProtoParametersSerialization serializeParameters(JwtMlDsaParameters parameters)
    ...
    return com.google.crypto.tink.jwt.internal.JwtMlDsaProtoSerialization.serializeParameters(
        parameters);
  }
  ...
  public static ProtoKeySerialization serializePublicKey(
    ...
    return com.google.crypto.tink.jwt.internal.JwtMlDsaProtoSerialization.serializePublicKey(
        key, access);
  }
  ...
  public static ProtoKeySerialization serializePrivateKey(
    ...
    return com.google.crypto.tink.jwt.internal.JwtMlDsaProtoSerialization.serializePrivateKey(
        key, access);
  }
  ...
  public static JwtMlDsaParameters parseParameters(ProtoParametersSerialization serialization)
      throws GeneralSecurityException {
    return com.google.crypto.tink.jwt.internal.JwtMlDsaProtoSerialization.parseParameters(
        serialization);
  }
  ...
  public static JwtMlDsaPublicKey parsePublicKey(
      ...
      throws GeneralSecurityException {
    return com.google.crypto.tink.jwt.internal.JwtMlDsaProtoSerialization.parsePublicKey(
  ...
  public static JwtMlDsaPrivateKey parsePrivateKey(
      ProtoKeySerialization serialization, @Nullable SecretKeyAccess access)
      throws GeneralSecurityException {
    return com.google.crypto.tink.jwt.internal.JwtMlDsaProtoSerialization.parsePrivateKey(
        serialization, access);
  }
