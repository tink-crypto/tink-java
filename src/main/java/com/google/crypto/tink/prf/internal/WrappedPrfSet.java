...
/** An implementation of PrfSet for a keyset. */
@Immutable
public final class WrappedPrfSet {
  private static class WrappedPrfSetImpl extends PrfSet {
    ...
    private WrappedPrfSetImpl(Map<Integer, Prf> keyIdToPrfMap, int primaryKeyId) {
