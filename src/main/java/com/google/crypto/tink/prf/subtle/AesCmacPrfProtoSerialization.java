...
/**
 * Public Proto Serialization for {@link AesCmacPrfKey} and {@link AesCmacPrfParameters}.
 */
@AccessesPartialKey
public final class AesCmacPrfProtoSerialization {
  ...
  public static ProtoParametersSerialization serializeParameters(
      AesCmacPrfParameters parameters) throws GeneralSecurityException {
    return com.google.crypto.tink.prf.internal.AesCmacPrfProtoSerialization.serializeParameters(
        parameters);
  }
  ...
  public static ProtoKeySerialization serializeKey(
    ...
    return com.google.crypto.tink.prf.internal.AesCmacPrfProtoSerialization.serializeKey(
        key, access);
  }
  ...
  @RestrictedApi(
      ...
      allowedOnPath = ".*Test\\.java",
      allowlistAnnotations = {LowLevelCryptoCaller.class})
  public static AesCmacPrfParameters parseParameters(
      ProtoParametersSerialization serialization) throws GeneralSecurityException {
    return com.google.crypto.tink.prf.internal.AesCmacPrfProtoSerialization.parseParameters(
        serialization);
  }
  ...
  public static AesCmacPrfKey parseKey(
    ...
    return com.google.crypto.tink.prf.internal.AesCmacPrfProtoSerialization.parseKey(
