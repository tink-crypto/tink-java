...
/**
 * Public Proto Serialization for {@link HmacPrfKey} and {@link HmacPrfParameters}.
 */
@AccessesPartialKey
public final class HmacPrfProtoSerialization {
  ...
  public static ProtoParametersSerialization serializeParameters(HmacPrfParameters parameters)
    ...
    return com.google.crypto.tink.prf.internal.HmacPrfProtoSerialization.serializeParameters(
        parameters);
  }
  ...
  public static ProtoKeySerialization serializeKey(
    ...
    return com.google.crypto.tink.prf.internal.HmacPrfProtoSerialization.serializeKey(
        key, access);
  }
  ...
  public static HmacPrfParameters parseParameters(ProtoParametersSerialization serialization)
      throws GeneralSecurityException {
    return com.google.crypto.tink.prf.internal.HmacPrfProtoSerialization.parseParameters(
        serialization);
  }
  ...
  public static HmacPrfKey parseKey(
      ...
      throws GeneralSecurityException {
    return com.google.crypto.tink.prf.internal.HmacPrfProtoSerialization.parseKey(
