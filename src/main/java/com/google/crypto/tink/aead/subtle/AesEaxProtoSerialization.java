...
/** Public Proto Serialization for {@link AesEaxKey} and {@link AesEaxParameters}. */
@AccessesPartialKey
public final class AesEaxProtoSerialization {
  ...
  public static ProtoParametersSerialization serializeParameters(AesEaxParameters parameters)
    ...
    return com.google.crypto.tink.aead.internal.AesEaxProtoSerialization.serializeParameters(
        parameters);
  }
  ...
  public static ProtoKeySerialization serializeKey(AesEaxKey key, @Nullable SecretKeyAccess access)
      throws GeneralSecurityException {
    return com.google.crypto.tink.aead.internal.AesEaxProtoSerialization.serializeKey(key, access);
  }
  ...
  public static AesEaxParameters parseParameters(ProtoParametersSerialization serialization)
      throws GeneralSecurityException {
    return com.google.crypto.tink.aead.internal.AesEaxProtoSerialization.parseParameters(
        serialization);
  }
  ...
  public static AesEaxKey parseKey(
      ...
      throws GeneralSecurityException {
    return com.google.crypto.tink.aead.internal.AesEaxProtoSerialization.parseKey(
