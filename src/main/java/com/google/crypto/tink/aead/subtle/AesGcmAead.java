...
/**
 * Provides an {@link Aead} from an {@link AesGcmKey}.
 *
 * <p>Historical note: this should be prefered over the similar class in {@link
 * com.google.crypto.tink.subtle.AesGcmJce}: we plan to standardize the API surface for primitives
 * from single keys with classes in {@code com.google.crypto.tink.<primitive>.subtle.ClassName}.
 */
public final class AesGcmAead {
