...
/**
 * Provides an {@link Aead} from an {@link AesCtrHmacAeadKey}.
 *
 * <p>Historical note: this should be preferred over the similar class in {@link
 * com.google.crypto.tink.subtle.EncryptThenAuthenticate}: we plan to standardize the API surface
 * for primitives from single keys with classes in {@code
...
public final class AesCtrHmacAead {
  ...
  public static Aead create(AesCtrHmacAeadKey key) throws GeneralSecurityException {
    return EncryptThenAuthenticate.create(key);
  }
