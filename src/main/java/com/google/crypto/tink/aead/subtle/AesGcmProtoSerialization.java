...
/** Public Proto Serialization for {@link AesGcmKey} and {@link AesGcmParameters}. */
@AccessesPartialKey
public final class AesGcmProtoSerialization {
  ...
  public static ProtoParametersSerialization serializeParameters(AesGcmParameters parameters)
    ...
    return com.google.crypto.tink.aead.internal.AesGcmProtoSerialization.serializeParameters(
        parameters);
  }
  ...
  public static ProtoKeySerialization serializeKey(AesGcmKey key, @Nullable SecretKeyAccess access)
      throws GeneralSecurityException {
    return com.google.crypto.tink.aead.internal.AesGcmProtoSerialization.serializeKey(key, access);
  }
  ...
  public static AesGcmParameters parseParameters(ProtoParametersSerialization serialization)
      throws GeneralSecurityException {
    return com.google.crypto.tink.aead.internal.AesGcmProtoSerialization.parseParameters(
        serialization);
  }
  ...
  public static AesGcmKey parseKey(
      ...
      throws GeneralSecurityException {
    return com.google.crypto.tink.aead.internal.AesGcmProtoSerialization.parseKey(
