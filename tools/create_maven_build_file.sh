...
gen_maven_jar_rules(
    name = "tink",
    # TODO b/442549419 - This produces a Maven bundle, but we never use it so far.
    create_snapshot_bundle = True,
    manifest_lines = [
        "Automatic-Module-Name: com.google.crypto.tink",
    ],
    pom_template_for_snapshot_bundle = "//maven:tink-java.pom.xml",
    root_packages = [
